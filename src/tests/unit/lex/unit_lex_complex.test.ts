...
const fullExpressions: Array<expressionEntry> = [
	...
	},
	{
		...
		tokens: [tk.OPERATOR_CHILD, tk.WHITESPACE, tk.MATCH_KEY_NAKED, tk.WHITESPACE, tk.OPERATOR_SIBLING_ANY, tk.WHITESPACE, tk.MATCH_KEY_NAKED, tk.WHITESPACE, tk.OPERATOR_SIBLING_ANY, tk.WHITESPACE, tk.MATCH_KEY_NAKED, tk.WHITESPACE, tk.OPERATOR_PARENT, tk.WHITESPACE, tk.OPERATOR_CHILD, tk.WHITESPACE, tk.MATCH_INDEX_OBJECT, ],
	},
	{
		expr: `𝒳 12345 01 || + 😂+😂`,
		tokens: [tk.ERROR, tk.WHITESPACE, tk.MATCH_INDEX_ALL, tk.WHITESPACE, tk.ERROR, tk.WHITESPACE, tk.OPERATOR_OR, tk.OPERATOR_OR, tk.WHITESPACE, tk.OPERATOR_SIBLING_NEXT, tk.WHITESPACE, tk.ERROR, tk.OPERATOR_SIBLING_NEXT, tk.ERROR, ],
	},
	{
		expr: String.raw`}}}}}}}"\\" #"\"du\npa\"" "\""00 aBBa dupa kupa213 ++ --- 1000 333  0 {000} {0} {1334} [313] [0] [000] #-0.312341E+0000123 #0 #123.0 #0E123 |`,
		tokens: [tk.ERROR, tk.MATCH_KEY, tk.WHITESPACE, tk.PRIMITIVE_STRING, tk.WHITESPACE, tk.MATCH_KEY, tk.ERROR, tk.WHITESPACE, tk.MATCH_KEY_NAKED, tk.WHITESPACE, tk.MATCH_KEY_NAKED, tk.WHITESPACE, tk.MATCH_KEY_NAKED, tk.MATCH_INDEX_ALL, tk.WHITESPACE, tk.OPERATOR_SIBLING_SUBSEQUENT, tk.WHITESPACE, tk.OPERATOR_SIBLING_PRECEDING, tk.OPERATOR_SIBLING_PREV, tk.WHITESPACE, tk.MATCH_INDEX_ALL, tk.WHITESPACE, tk.MATCH_INDEX_ALL, tk.WHITESPACE, tk.MATCH_INDEX_ALL, tk.WHITESPACE, tk.ERROR, tk.WHITESPACE, tk.MATCH_INDEX_OBJECT, tk.WHITESPACE, tk.MATCH_INDEX_OBJECT, tk.WHITESPACE, tk.MATCH_INDEX_ARRAY, tk.WHITESPACE, tk.MATCH_INDEX_ARRAY, tk.WHITESPACE, tk.ERROR, tk.WHITESPACE, tk.PRIMITIVE_NUMBER, tk.WHITESPACE, tk.PRIMITIVE_NUMBER, tk.WHITESPACE, tk.PRIMITIVE_NUMBER, tk.WHITESPACE, tk.PRIMITIVE_NUMBER, tk.WHITESPACE, tk.OPERATOR_OR, ],
	},
	{
		expr: ``,
		tokens: [],
