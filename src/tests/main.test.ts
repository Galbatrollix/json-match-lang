import {tokenizeMatchString, type TokenTape, tokenTapeUtils} from "../main.ts"
...
console.log(testt);
const result: TokenTape = tokenizeMatchString(testt);
...
const schizoTape = tokenizeMatchString(schizo);
...
console.log("Basic check: ", debug.integrityCheckDeep(tokenizeMatchString(" ")));


const temp = " ";
const tempResult = tokenizeMatchString(temp);
