...
function stackOverflowError(tokenIndex) {
    return {
        targetKind: parser_errors_ts_1.ParseErrorKind.STACK_OVERFLOW,
...
const combinatorConversionTable = {
    [lexer.TokenKind.OPERATOR_CHILD]: parser_types_ts_1.ExpressionCombinator.CHILD,
    [lexer.TokenKind.OPERATOR_PARENT]: parser_types_ts_1.ExpressionCombinator.PARENT,
    [lexer.TokenKind.OPERATOR_SIBLING_NEXT]: parser_types_ts_1.ExpressionCombinator.SIBLING_NEXT,
    [lexer.TokenKind.OPERATOR_SIBLING_PREV]: parser_types_ts_1.ExpressionCombinator.SIBLING_PREV,
    [lexer.TokenKind.OPERATOR_SIBLING_SUBSEQUENT]: parser_types_ts_1.ExpressionCombinator.SIBLING_SUBSEQUENT,
    [lexer.TokenKind.OPERATOR_SIBLING_PRECEDING]: parser_types_ts_1.ExpressionCombinator.SIBLING_PRECEDING,
    [lexer.TokenKind.OPERATOR_SIBLING_ANY]: parser_types_ts_1.ExpressionCombinator.SIBLING_ANY,
};
...
function combinatorImplicitDescendant() {
    return {
        combinator: parser_types_ts_1.ExpressionCombinator.DESCENDANT,
        consumed: 0,
        success: true,
    };
}
...
function parseExpressionConstraint(tokens, start) {
    ...
    return (0, parser_constraints_ts_1.parseConstraintsTopLevel)(tokens, start);
}
/**
