...
exports.lexJsonPathString = lexJsonPathString;
...
function lexJsonPathString(characterList) {
    ...
    const result = [{ kind: lexer_enum_ts_1.TokenKind.HEAD, endIdx: 0 }];
...
const LexFunctionsCollection = [
    ...
    { fn: lexOperatorChild, kind: lexer_enum_ts_1.TokenKind.OPERATOR_CHILD },
    { fn: lexOperatorParent, kind: lexer_enum_ts_1.TokenKind.OPERATOR_PARENT },
    // must be before next and prev as they are superset of the latter
    { fn: lexOperatorSiblingSubsequent, kind: lexer_enum_ts_1.TokenKind.OPERATOR_SIBLING_SUBSEQUENT },
    { fn: lexOperatorSiblingPreceding, kind: lexer_enum_ts_1.TokenKind.OPERATOR_SIBLING_PRECEDING },
    { fn: lexOperatorSiblingNext, kind: lexer_enum_ts_1.TokenKind.OPERATOR_SIBLING_NEXT },
    { fn: lexOperatorSiblingPrev, kind: lexer_enum_ts_1.TokenKind.OPERATOR_SIBLING_PREV },
    { fn: lexOperatorSiblingAny, kind: lexer_enum_ts_1.TokenKind.OPERATOR_SIBLING_ANY },
    { fn: lexOperatorOr, kind: lexer_enum_ts_1.TokenKind.OPERATOR_OR },
    { fn: lexOperatorAnd, kind: lexer_enum_ts_1.TokenKind.OPERATOR_AND },
    { fn: lexOperatorNot, kind: lexer_enum_ts_1.TokenKind.OPERATOR_NOT },
    { fn: lexMatchKey, kind: lexer_enum_ts_1.TokenKind.MATCH_KEY },
    { fn: lexMatchKeyNaked, kind: lexer_enum_ts_1.TokenKind.MATCH_KEY_NAKED },
    { fn: lexMatchIndexAll, kind: lexer_enum_ts_1.TokenKind.MATCH_INDEX_ALL },
    { fn: lexMatchIndexArray, kind: lexer_enum_ts_1.TokenKind.MATCH_INDEX_ARRAY },
    { fn: lexMatchIndexObject, kind: lexer_enum_ts_1.TokenKind.MATCH_INDEX_OBJECT },
    { fn: lexMatchWildcardAll, kind: lexer_enum_ts_1.TokenKind.MATCH_WILDCARD_ALL },
    { fn: lexMatchWildcardArray, kind: lexer_enum_ts_1.TokenKind.MATCH_WILDCARD_ARRAY },
    { fn: lexMatchWildcardObject, kind: lexer_enum_ts_1.TokenKind.MATCH_WILDCARD_OBJECT },
    { fn: lexPrimitiveKindWildcard, kind: lexer_enum_ts_1.TokenKind.PRIMITIVE_KIND_WILDCARD },
    { fn: lexPrimitiveKindString, kind: lexer_enum_ts_1.TokenKind.PRIMITIVE_KIND_STRING },
    { fn: lexPrimitiveKindNumber, kind: lexer_enum_ts_1.TokenKind.PRIMITIVE_KIND_NUMBER },
    { fn: lexPrimitiveKindBoolean, kind: lexer_enum_ts_1.TokenKind.PRIMITIVE_KIND_BOOLEAN },
    { fn: lexPrimitiveNull, kind: lexer_enum_ts_1.TokenKind.PRIMITIVE_NULL },
    { fn: lexPrimitiveTrue, kind: lexer_enum_ts_1.TokenKind.PRIMITIVE_TRUE },
    { fn: lexPrimitiveFalse, kind: lexer_enum_ts_1.TokenKind.PRIMITIVE_FALSE },
    { fn: lexPrimitiveString, kind: lexer_enum_ts_1.TokenKind.PRIMITIVE_STRING },
    { fn: lexPrimitiveNumber, kind: lexer_enum_ts_1.TokenKind.PRIMITIVE_NUMBER },
    //must always be last
    { fn: lexError, kind: lexer_enum_ts_1.TokenKind.ERROR },
];
