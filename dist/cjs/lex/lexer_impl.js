...
const LexFunctionsCollection = [
    ...
    { fn: lexer_functions_ts_1.funcs.lexMatchIndexArray, kind: lexer_enum_ts_1.TokenKind.MATCH_INDEX_ARRAY },
    { fn: lexer_functions_ts_1.funcs.lexMatchIndexObject, kind: lexer_enum_ts_1.TokenKind.MATCH_INDEX_OBJECT },
    { fn: lexer_functions_ts_1.funcs.lexMatchWildcardAll, kind: lexer_enum_ts_1.TokenKind.MATCH_WILDCARD_ALL },
    { fn: lexer_functions_ts_1.funcs.lexMatchWildcardArray, kind: lexer_enum_ts_1.TokenKind.MATCH_WILDCARD_ARRAY },
    { fn: lexer_functions_ts_1.funcs.lexMatchWildcardObject, kind: lexer_enum_ts_1.TokenKind.MATCH_WILDCARD_OBJECT },
    { fn: lexer_functions_ts_1.funcs.lexPrimitiveKindWildcard, kind: lexer_enum_ts_1.TokenKind.PRIMITIVE_KIND_WILDCARD },
    { fn: lexer_functions_ts_1.funcs.lexPrimitiveKindString, kind: lexer_enum_ts_1.TokenKind.PRIMITIVE_KIND_STRING },
    { fn: lexer_functions_ts_1.funcs.lexPrimitiveKindNumber, kind: lexer_enum_ts_1.TokenKind.PRIMITIVE_KIND_NUMBER },
    { fn: lexer_functions_ts_1.funcs.lexPrimitiveKindBoolean, kind: lexer_enum_ts_1.TokenKind.PRIMITIVE_KIND_BOOLEAN },
    { fn: lexer_functions_ts_1.funcs.lexPrimitiveNull, kind: lexer_enum_ts_1.TokenKind.PRIMITIVE_NULL },
    { fn: lexer_functions_ts_1.funcs.lexPrimitiveTrue, kind: lexer_enum_ts_1.TokenKind.PRIMITIVE_TRUE },
